    ...
    <div className="flex flex-col items-center px-4 animate-in fade-in duration-300">
      ...
      <div ref={imgContainerRef} className="relative w-full max-w-2xl mx-auto mb-6">
        ...
        <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="absolute inset-0 w-full h-full">
          <defs>
            <radialGradient id="hotspot-glow-light">
            ...
            <style>{`
              ...
              @keyframes hotspot-core-pulse-light {
          ...
          {(() => {
            const darkRegions = ["nord", "nordest", "sudest", "sudovest"];
            const isDark = darkRegions.includes(region.id);
            return regionHotspots.map((hs, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <circle
                    ...
                    cy={hs.y}
                    r={5}
                    fill={isDark ? "url(#hotspot-glow-dark)" : "url(#hotspot-glow-light)"}
                    stroke="none"
                    style={{
